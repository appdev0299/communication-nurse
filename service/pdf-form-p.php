...
$stmt = $conn->prepare("SELECT id, ref, fullname, department, tel, personnel, email, social, option, date_a, communicate, production_file, status_user, status_admin, status_ss, status_email, created_at FROM ccfn_form_p WHERE id = :id AND ref = :ref");
...
if ($row) {
    ...
    $production_file = $row['production_file']; // Adjusted to match the column name
...
$pdf->Output('แบบร้องขอการออกแบบ.pdf', 'I');
$pdf->Close();
