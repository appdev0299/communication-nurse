...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT fullname, email, status_email FROM ccfn_form_s WHERE id = :id");
        ...
        if ($result) {
            ...
            if ($status_email == 0) {
                ...
                $email_content = "
                    ...
                    <body>
                        <div class='container'>
                            ...
                            <div class='content'>
                                <p>สวัสดี $fullname</p>
                                <p>ขอบคุณสำหรับการใช้บริการร้องขอประชาสัมพันธ์ ของหน่วยสื่อสารและภาพลักษณ์องค์กร</p>
                ...
                if ($mail->send()) {
                    ...
                    $update_stmt = $conn->prepare("UPDATE ccfn_form_s SET status_email = 1 WHERE id = :id");
