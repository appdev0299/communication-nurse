                            ...
                            <div class="table-responsive text-nowrap">
                                <table id="example" class="table table-borderless" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $stmt = $conn->prepare("SELECT * FROM ccfn_form_s WHERE status_user = 3 ORDER BY id DESC");
                                        $stmt->execute();
                                                        ...
                                                        <td>
                                                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                                                                <li class="user-details">
                                                                    <strong><?= $t1['responsible_1']; ?></strong><br>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item" href="../user-list/details-s?id=<?= $t1['id']; ?>?ref=<?= $t1['ref']; ?>"><i class="bx bx-edit-alt me-1"></i>เปิด</a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
